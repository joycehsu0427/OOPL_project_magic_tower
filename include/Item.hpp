...
public:
    Item(const std::vector<std::string> &data, int x, int y, const std::shared_ptr<Player> &player, const std::shared_ptr<ItemDialog> &itemDialog) : Thing("Item/" + data[0], false, x, y),
